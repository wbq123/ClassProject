...
public class VpActivity extends AppCompatActivity {
    ...
    private static final String TAG = VpActivity.class.getSimpleName();//根据API中的定义，Class.getSimpleName()方法是获取源代码中给出的‘底层类’简称
    ViewPager mViewPager;
    List<Integer> mVpList;
    int mPreviousSelected = 0;//当前选中页
    ImageView[] imageViews; //对应 的图片
